...
def cmd_execute(args):
    ...
    if args.mode == "create":
        ...
        description = (args.description or "Generated by plumbeer-music-producer-playlist.")[:5000]
        try:
            resp = requests.post(
...
def main():
    ...
    p_execute.add_argument(
        "--description",
        default=None,
        help="Only used with --mode create. Defaults to 'Generated by plumbeer-music-producer-playlist.'",
    )
